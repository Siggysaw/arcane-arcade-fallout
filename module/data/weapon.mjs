...
export default class FalloutZeroItemWeapon extends FalloutZeroItemBase {
  static defineSchema() {
    ...
    schema.npcAttack = new fields.BooleanField({ initial: false })
    schema.npcAttackBonus = new fields.NumberField({ initial: 0, nullable: false })
    schema.npcDamageBonus = new fields.NumberField({ initial: 0, nullable: false })
