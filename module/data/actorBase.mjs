  ...
  async determineNpcLoot(myActor, whisper, playerName) {
    ...
    const monsterLoot = [
      ...
      },
      {
        ...
        dice: 'LckDC10',
        loot: [{ all: [['junk', 'Radioactive Gland']] }, { dc: [['money', 'Bottlecap']] }],
      },
      {
      ...
      { name: 'Dog', dice: 'All', loot: [{ all: [['junk', 'Dog Meat']] }] },
      { name: 'Dog', dice: 'All', loot: [{ all: [['junk', 'Dog Meat']] }] },
      { name: 'Mongrel', dice: 'All', loot: [{ all: [['junk', 'Mongrel Meat']] }] },
      { name: 'Mongrel Alpha', dice: 'All', loot: [{ all: [['junk', 'Mongrel Meat']] }] },
      { name: 'Mole Rat', dice: 'All', loot: [{ all: [['junk', 'Mole Rat Meat']] }] },
      {
      ...
      { name: 'Mutated Bear', dice: 'All', loot: [{ all: [['junk', 'Bear Meat']] }] },
      {
        name: 'Deathclaw',
        dice: 'All',
        loot: [
      ...
      { name: 'Giant Ant', dice: 'All', loot: [{ all: [['junk', 'Ant Meat']] }] },
      { name: 'Giant Ant Soldier', dice: 'All', loot: [{ all: [['junk', 'Ant Meat']] }] },
      { name: 'Fire Ant', dice: 'All', loot: [{ all: [['junk', 'Fire Ant Meat']] }] },
      {
      ...
      { name: 'Bloatfly', dice: 'All', loot: [{ all: [['junk', 'Bloatfly Meat']] }] },
      { name: 'Bloatfly Black', dice: 'All', loot: [{ all: [['junk', 'Bloatfly Meat']] }] },
      { name: 'Bloodbug', dice: 'All', loot: [{ all: [['junk', 'Bloodbug Meat']] }] },
      {
        name: 'Fog Crawler',
        dice: 'All',
        loot: [
      ...
      { name: 'Mirelurk', dice: 'All', loot: [{ all: [['junk', 'Mirelurk Meat']] }] },
      { name: 'Mirelurk Razorclaw', dice: 'All', loot: [{ all: [['junk', 'Mirelurk Meat']] }] },
      {
        name: 'Mirelurk Queen',
        dice: 'All',
        loot: [
      ...
      },
      {
        name: 'Cazador',
        dice: 'LckDC15',
        loot: [{ all: [['junk', 'Cazador Poison Gland']] }, { dc: [['junk', 'Cazador Egg']] }],
      },
      { name: 'Cazador Young', dice: 'All', loot: [{ all: [['junk', 'Cazador Poison Gland']] }] },
      {
      ...
      },
      {
        ...
        loot: [
          {
            all: [
              ['junk', 'Radscorpion Poison Gland'],
              ['junk', 'Radscorpion Meat'],
            ],
          },
      ...
      { name: 'Radroach', dice: 'All', loot: [{ all: [['junk', 'Radroach Meat']] }] },
      { name: 'Rattler', dice: 'All', loot: [{ all: [['junk', 'Rattler Poison Gland']] }] },
      { name: 'Stingwing', dice: 'All', loot: [{ all: [['junk', 'Stingwing Meat']] }] },
      { name: 'Stingwing Skimmer', dice: 'All', loot: [{ all: [['junk', 'Stingwing Meat']] }] },
      { name: 'Stingwing Chaser', dice: 'All', loot: [{ all: [['junk', 'Stingwing Meat']] }] },
      {
        name: 'Assaultron',
        dice: 'All',
        loot: [
      ...
      { name: 'Junkie', dice: 'All', loot: [{ all: [['text', 'Nothing']] }] },
